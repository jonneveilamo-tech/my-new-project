...
Possible small demo (try it live!): [Forest Fire Detection Demo on Hugging Face](https://huggingface.co/spaces/earthtoolsmaker/forest-fire-pyronear) – Upload an image to see fire/smoke analysis in action.
